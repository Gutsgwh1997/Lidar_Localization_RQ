/**
 * @file data_preprocessing_flow.hpp
 * @brief 数据预处理模块，包括原始消息的接收，时间同步，点云去畸变
 * @author GWH
 * @version 0.1
 * @date 2020-03-09
 */
#ifndef LIDAR_LOCALIZATION_DATA_PRETREAT_DATA_PREPROCESSING_FLOW_HPP_
#define LIDAR_LOCALIZATION_DATA_PRETREAT_DATA_PREPROCESSING_FLOW_HPP_
...
class DataPreprocessFlow {
   ...
   private:
    ...
    bool HasData();
    bool ValidData();
    bool TransformData();   // 将GNSS的位置转换为以Lidar的，点云去畸变
    bool PublishData();
   private:
    // subscriber
    ...
    CloudData distortioned_cloud_data_;
